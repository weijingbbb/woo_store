...
class Privilege {
  ...
  static Future<PrivilegeStatus> photos() async {
    var value = false;
    // Console.log('isIOS: ${GetPlatform.isIOS}, platform: ${Platform.isIOS}');
    if (GetPlatform.isIOS) {
      var statuses = await [Permission.photos].request();
      Console.log('isIOS--statuses: ${statuses[Permission.photos]}');
      value = statuses[Permission.photos] == PermissionStatus.granted;
    }
    if (GetPlatform.isAndroid) {
      var statuses = await [Permission.storage].request();
      Console.log('isAndroid--statuses: ${statuses[Permission.photos]}');
